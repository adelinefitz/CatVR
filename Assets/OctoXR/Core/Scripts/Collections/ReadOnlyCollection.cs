...
namespace OctoXR.Collections
{
	...
	/// <typeparam name="T">The type of elements in the collection</typeparam>
	[Serializable]
	public class ReadOnlyList<T> : ReadOnlyCollection<T, List<T>>
	{
		//public ReadOnlyList() { }
	...
	/// <typeparam name="T">The type of elements in the collection</typeparam>
	[Serializable]
	public class ReadOnlyCollection<T> : IList<T>, IList, IReadOnlyList<T>, IReadOnlyCollection<T>, IEnumerable<T>
	{
		[SerializeField]
		protected T[] items;
		[SerializeField]
